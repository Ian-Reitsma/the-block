...
- BlockTorch strategy references live in [`docs/ECONOMIC_PHILOSOPHY_AND_GOVERNANCE_ANALYSIS.md`](../../docs/ECONOMIC_PHILOSOPHY_AND_GOVERNANCE_ANALYSIS.md#part-xii-blocktorch--the-compute-framework-strategy) and should be kept in sync with these design notes.

## Current Status
 - `project_status.md` and `tensor.md` are current as of January 2026 and chart both the experimental bridge and the Metal-native tensor implementation.
