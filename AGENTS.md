...
**Latest highlights (2025-10-08 update: governance/ledger/metrics aggregator now encode via the first-party serialization facade; remaining serde_json/bincode usage lives in tooling):**
