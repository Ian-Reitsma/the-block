...
> **Review (2025-09-25):** Synced Telemetry Operations Runbook guidance with the dependency-sovereignty pivot and confirmed readiness + token hygiene.
...
- **Ad readiness** – Dashboards now chart `ad_readiness_ready`,
  ...
  `ad_readiness_it_price_usd_micros`, and their configured minimums alongside the
