...
- The WAN chaos dashboards ingest the new
  ...
  path hermetic by exercising `/chaos/attest` end-to-end with the first-party
  simulation crate, and decode coverage rejects forged signatures, malformed
  module names, and truncated byte arrays before readiness gauges update.
