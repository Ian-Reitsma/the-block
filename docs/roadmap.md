# Status & Roadmap
> **Review (2025-09-25):** Raised readiness to 98.9/92.0, synced pillar percentages with new evidence, and removed future-dated milestones.

Mainnet readiness: 98.9/100 · Vision completion: 92.0/100.
...
timelines, wire SLA slashing dashboards atop the lane-aware matcher, automate
storage migration tooling for RocksDB↔sled swaps, continue WAN-scale QUIC chaos
drills with published mitigation guides, extend bridge/DEX docs with multisig
signer-set payloads plus release-verifier walkthroughs, stand up the dependency
fault simulation harness, and finish the multisig wallet UX polish.
