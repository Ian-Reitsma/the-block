# Status & Roadmap
> **Review (2025-09-29):** Tightened readiness to 98.3/93.3 after re-checking that the aggregator and gateway servers still rely on `axum`/`hyper` while `crates/httpd` remains client-only today.
