# Status & Roadmap
> **Review (2025-09-25):** Synced Status & Roadmap guidance with the dependency-sovereignty pivot and confirmed readiness + token hygiene.
> Dependency pivot status: Runtime, transport, overlay, storage_engine, coding, crypto_suite, and codec wrappers are live with governance overrides enforced (2025-09-25).

Mainnet readiness: 99.2/100 · Vision completion: 93.4/100.
