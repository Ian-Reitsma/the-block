...
| unclassified | `base64` | 0.22.1 | crates.io | MIT OR Apache-2.0 | 4 |
| unclassified | `base64_fp` | 0.1.0 | workspace | — | 1 |
| unclassified | `bitflags` | 1.3.2 | crates.io | MIT/Apache-2.0 | 3 |
...
| unclassified | `cc` | 1.2.40 | crates.io | MIT OR Apache-2.0 | 3 |
...
| unclassified | `crc32fast` | 1.5.0 | crates.io | MIT OR Apache-2.0 | 2 |
...
| unclassified | `debugid` | 0.8.0 | crates.io | Apache-2.0 | 4 |
...
| unclassified | `displaydoc` | 0.2.5 | crates.io | MIT OR Apache-2.0 | 2 |
...
| unclassified | `fallible-iterator` | 0.3.0 | crates.io | MIT/Apache-2.0 | 4 |
| unclassified | `fallible-streaming-iterator` | 0.1.9 | crates.io | MIT/Apache-2.0 | 4 |
| unclassified | `fastrand` | 2.3.0 | crates.io | Apache-2.0 OR MIT | 2 |
| unclassified | `filetime` | 0.2.26 | crates.io | MIT/Apache-2.0 | 2 |
| unclassified | `find-msvc-tools` | 0.1.3 | crates.io | MIT OR Apache-2.0 | 4 |
| unclassified | `findshlibs` | 0.10.2 | crates.io | MIT OR Apache-2.0 | 2 |
| unclassified | `flate2` | 1.1.4 | crates.io | MIT OR Apache-2.0 | 1 |
...
| unclassified | `form_urlencoded` | 1.2.2 | crates.io | MIT OR Apache-2.0 | 3 |
...
| unclassified | `icu_collections` | 2.0.0 | crates.io | Unicode-3.0 | 2 |
| unclassified | `icu_locale_core` | 2.0.0 | crates.io | Unicode-3.0 | 3 |
| unclassified | `icu_normalizer` | 2.0.0 | crates.io | Unicode-3.0 | 1 |
| unclassified | `icu_normalizer_data` | 2.0.0 | crates.io | Unicode-3.0 | 2 |
| unclassified | `icu_properties` | 2.0.1 | crates.io | Unicode-3.0 | 2 |
| unclassified | `icu_properties_data` | 2.0.1 | crates.io | Unicode-3.0 | 3 |
...
| unclassified | `is-terminal` | 0.4.16 | crates.io | MIT | 3 |
...
| unclassified | `libsqlite3-sys` | 0.27.0 | crates.io | MIT | 4 |
...
| unclassified | `litemap` | 0.8.0 | crates.io | Unicode-3.0 | 4 |
| unclassified | `lock_api` | 0.4.14 | crates.io | MIT OR Apache-2.0 | 3 |
...
| unclassified | `once_cell` | 1.21.3 | crates.io | MIT OR Apache-2.0 | 2 |
...
| unclassified | `parking_lot` | 0.12.5 | crates.io | MIT OR Apache-2.0 | 2 |
| unclassified | `parking_lot_core` | 0.9.12 | crates.io | MIT OR Apache-2.0 | 3 |
| unclassified | `pem` | 3.0.5 | crates.io | MIT | 3 |
| unclassified | `percent-encoding` | 2.3.2 | crates.io | MIT OR Apache-2.0 | 3 |
...
| unclassified | `potential_utf` | 0.1.3 | crates.io | Unicode-3.0 | 3 |
...
| unclassified | `rusqlite` | 0.30.0 | crates.io | MIT | 3 |
...
| unclassified | `scopeguard` | 1.2.0 | crates.io | MIT OR Apache-2.0 | 4 |
...
| unclassified | `tinystr` | 0.8.1 | crates.io | Unicode-3.0 | 3 |
...
| unclassified | `url` | 2.5.7 | crates.io | MIT OR Apache-2.0 | 2 |
| unclassified | `utf16_iter` | 1.0.5 | crates.io | Apache-2.0 OR MIT | 2 |
| unclassified | `utf8_iter` | 1.0.4 | crates.io | Apache-2.0 OR MIT | 2 |
...
| unclassified | `web-sys` | 0.3.81 | crates.io | MIT OR Apache-2.0 | 4 |
| unclassified | `winapi` | 0.3.9 | crates.io | MIT/Apache-2.0 | 3 |
| unclassified | `winapi-i686-pc-windows-gnu` | 0.4.0 | crates.io | MIT/Apache-2.0 | 4 |
| unclassified | `winapi-x86_64-pc-windows-gnu` | 0.4.0 | crates.io | MIT/Apache-2.0 | 4 |
| unclassified | `windows-link` | 0.2.1 | crates.io | MIT OR Apache-2.0 | 3 |
...
| unclassified | `windows-sys` | 0.61.2 | crates.io | MIT OR Apache-2.0 | 2 |
...
| unclassified | `windows-targets` | 0.53.5 | crates.io | MIT OR Apache-2.0 | 4 |
...
| unclassified | `windows_aarch64_gnullvm` | 0.53.1 | crates.io | MIT OR Apache-2.0 | 5 |
...
| unclassified | `windows_aarch64_msvc` | 0.53.1 | crates.io | MIT OR Apache-2.0 | 5 |
...
| unclassified | `windows_i686_gnu` | 0.53.1 | crates.io | MIT OR Apache-2.0 | 5 |
| unclassified | `windows_i686_gnullvm` | 0.52.6 | crates.io | MIT OR Apache-2.0 | 4 |
| unclassified | `windows_i686_gnullvm` | 0.53.1 | crates.io | MIT OR Apache-2.0 | 5 |
...
| unclassified | `windows_i686_msvc` | 0.53.1 | crates.io | MIT OR Apache-2.0 | 5 |
...
| unclassified | `windows_x86_64_gnu` | 0.53.1 | crates.io | MIT OR Apache-2.0 | 5 |
...
| unclassified | `windows_x86_64_gnullvm` | 0.53.1 | crates.io | MIT OR Apache-2.0 | 5 |
...
| unclassified | `windows_x86_64_msvc` | 0.53.1 | crates.io | MIT OR Apache-2.0 | 5 |
| unclassified | `wit-bindgen` | 0.46.0 | crates.io | Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT | 5 |
| unclassified | `write16` | 1.0.0 | crates.io | Apache-2.0 OR MIT | 2 |
| unclassified | `writeable` | 0.6.1 | crates.io | Unicode-3.0 | 3 |
...
| unclassified | `yoke` | 0.8.0 | crates.io | Unicode-3.0 | 3 |
| unclassified | `yoke-derive` | 0.8.0 | crates.io | Unicode-3.0 | 4 |
...
| unclassified | `zerofrom` | 0.1.6 | crates.io | Unicode-3.0 | 3 |
| unclassified | `zerofrom-derive` | 0.1.6 | crates.io | Unicode-3.0 | 4 |
| unclassified | `zerotrie` | 0.2.2 | crates.io | Unicode-3.0 | 3 |
| unclassified | `zerovec` | 0.11.4 | crates.io | Unicode-3.0 | 2 |
| unclassified | `zerovec-derive` | 0.11.1 | crates.io | Unicode-3.0 | 3 |
