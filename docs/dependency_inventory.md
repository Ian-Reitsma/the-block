...
| unclassified | `foundation_metrics` | 0.1.0 | workspace | MIT | 1 |
...
| unclassified | `getrandom` | 0.3.3 | crates.io | MIT OR Apache-2.0 | 4 |
...
| unclassified | `r-efi` | 5.3.0 | crates.io | MIT OR Apache-2.0 OR LGPL-2.1-or-later | 5 |
...
| unclassified | `tls_warning` | 0.1.0 | workspace | — | 1 |
...
| unclassified | `version_check` | 0.9.5 | crates.io | MIT/Apache-2.0 | 8 |
...
| unclassified | `wasi` | 0.14.7+wasi-0.2.4 | crates.io | Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT | 5 |
| unclassified | `wasip2` | 1.0.1+wasi-0.2.4 | crates.io | Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT | 6 |
...
| unclassified | `wit-bindgen` | 0.46.0 | crates.io | Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT | 7 |
