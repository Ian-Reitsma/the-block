...
- `docs/consensus.md`, `docs/difficulty.md`, `docs/poh.md`, `docs/dkg.md`, `docs/sharding.md`, `docs/macro_block.md`, `docs/blob_chain.md`, `docs/hashlayout.md`, `docs/genesis_history.md`, `docs/serialization.md`, `docs/schema_migrations/v7_recent_timestamps.md` → [`Ledger and Consensus`](architecture.md#ledger-and-consensus)
...
- `docs/storage.md`, `docs/storage_pipeline.md`, `docs/storage_erasure.md`, `docs/storage_market.md`, `docs/storage/repair.md`, `docs/simple_db.md`, `docs/wal.md`, `docs/snapshots.md`, `docs/state_pruning.md`, `docs/snapshot.md`, `docs/schema_migrations/v10_industrial_subsidies.md` → [`Storage and State`](architecture.md#storage-and-state)
...
- `docs/dex.md`, `docs/dex_amm.md`, `docs/schema_migrations/v9_dex_escrow.md` → [`DEX and Trust Lines`](architecture.md#dex-and-trust-lines)
- `docs/bridges.md`, `docs/bridge_security.md`, `docs/schema_migrations/v8_bridge_headers.md` → [`Token Bridges`](architecture.md#token-bridges)
