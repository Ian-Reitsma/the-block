...
- Ship `node/src/chain_spec_block_os.rs` with `block_os_testnet_config`. Launch public nodes + mock meters.
...
- Outcome: readiness report for “Block OS - Energy” launch, including sign-offs from consensus, governance, storage, and telemetry owners.
