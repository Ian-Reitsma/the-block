...
fn param_key_to_tag(key: ParamKey) -> u8 {
    match key {
        ...
        ParamKey::BetaStorageSub => 5,
        ParamKey::GammaReadSub => 6,
        ParamKey::KappaCpuSub => 7,
        ParamKey::LambdaBytesOutSub => 8,
        ...
        ParamKey::TreasuryPercent => 14,
        ParamKey::ProofRebateLimit => 15,
        ParamKey::ProofVerificationBudgetMs => 111,
        ParamKey::RentRatePerByte => 16,
...
fn param_key_from_tag(tag: u8) -> Result<ParamKey> {
    let key = match tag {
        ...
        5 => ParamKey::BetaStorageSub,
        6 => ParamKey::GammaReadSub,
        7 => ParamKey::KappaCpuSub,
        8 => ParamKey::LambdaBytesOutSub,
        ...
        14 => ParamKey::TreasuryPercent,
        15 => ParamKey::ProofRebateLimit,
        111 => ParamKey::ProofVerificationBudgetMs,
        16 => ParamKey::RentRatePerByte,
        ...
        43 => ParamKey::LaneBasedSettlementEnabled,
...
pub fn param_key_to_string(key: ParamKey) -> &'static str {
    match key {
        ...
        ParamKey::BetaStorageSub => "BetaStorageSub",
        ParamKey::GammaReadSub => "GammaReadSub",
        ParamKey::KappaCpuSub => "KappaCpuSub",
        ParamKey::LambdaBytesOutSub => "LambdaBytesOutSub",
        ...
        ParamKey::LaneBasedSettlementEnabled => "LaneBasedSettlementEnabled",
...
pub fn param_key_from_string(value: &str) -> Result<ParamKey> {
    match value {
        ...
        "BetaStorageSub" => Ok(ParamKey::BetaStorageSub),
        "GammaReadSub" => Ok(ParamKey::GammaReadSub),
        "KappaCpuSub" => Ok(ParamKey::KappaCpuSub),
        "LambdaBytesOutSub" => Ok(ParamKey::LambdaBytesOutSub),
        ...
        "LaneBasedSettlementEnabled" => Ok(ParamKey::LaneBasedSettlementEnabled),
