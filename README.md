...
| **`metal-backend/`** | BlockTorch compute framework (metal-tensor + autograd) for deterministic tensor ops and Metal/CPU backends | FlashAttention bridge, profiling hooks, kernel/runtime stack, and migration path to verified compute workloads |
