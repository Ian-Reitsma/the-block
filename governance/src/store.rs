...
impl GovStore {
    ...
    fn treasury_executor_state_path(&self) -> PathBuf {
        self.base_path
            .join("governance")
            .join("treasury_executor_state.json")
    }
    ...
    fn treasury_executor_state_tree(&self) -> sled::Tree {
        self.db
            .open_tree("treasury/executor_state")
            .unwrap_or_else(|e| panic!("open treasury executor state tree: {e}"))
    }
