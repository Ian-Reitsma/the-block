...
mod tests {
    ...
    fn roundtrip_duty_record() {
        ...
        let value =
            foundation_serialization::json::to_value(&record).expect("serialize duty record");
        let decoded: DutyRecord =
            foundation_serialization::json::from_value(value).expect("decode duty record");
    ...
    fn settlement_duty_serialization() {
        ...
        let value =
            foundation_serialization::json::to_value(&record).expect("serialize settlement duty");
        let decoded: DutyRecord =
            foundation_serialization::json::from_value(value).expect("decode settlement duty");
