//! Helper deserializers for in-memory values.
    ...
    E: Error,
{
        ...
        V: Visitor<'de>,
    {
        ...
        visitor.visit_enum(StringEnumDeserializer::new(value))
    }
...
/// Helper trait to convert a value into a deserializer.
...
/// Helper for deserializing enum from a string.
    ...
    E: Error,
{
    ...
    where
        V: Visitor<'de>,
    {
        visitor.visit_enum(UnitOnlyVariantAccess {
            value: self.value,
            marker: std::marker::PhantomData,
        })
    }
...
impl<'de, E> super::VariantAccess<'de> for UnitOnly<E>
where
    E: Error,
{
    type Error = E;
...
struct StringEnumDeserializer<E> {
    value: String,
    marker: std::marker::PhantomData<E>,
}

impl<E> StringEnumDeserializer<E> {
    fn new(value: String) -> Self {
        StringEnumDeserializer {
            value,
            marker: std::marker::PhantomData,
        }
    }
...
impl<'de, E> super::EnumAccess<'de> for StringEnumDeserializer<E>
where
    E: Error,
{
    type Error = E;
...
impl<'de, E> super::Deserializer<'de> for U32Deserializer<E>
where
    E: Error,
{
    type Error = E;
